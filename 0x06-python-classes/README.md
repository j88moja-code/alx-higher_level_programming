...
* [1-square.py]() - a class `Square` thalass Square that defines a square by: (based on `0-square.py`)
* [2-square.py]() - a class `Square` thalass Square that defines a square by: (based on `1-square.py`)
